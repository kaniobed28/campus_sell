...
// import 'custom_horizontal_products_list.dart';

// class AgoTechHome extends StatefulWidget {
//   const AgoTechHome({super.key});

//   @override
//   State<AgoTechHome> createState() => _AgoTechHomeState();
// }

// class _AgoTechHomeState extends State<AgoTechHome> {
...
//           CustomHorizontalProductsList(
//             lists: lists[1],
//             categoryLable: 'Electronics',
//           ),
//           CustomHorizontalProductsList(
//             lists: lists[2],
//             categoryLable: 'Health Products',
//           ),
//           CustomHorizontalProductsList(
//             lists: lists[3],
//             categoryLable: 'Beauty Products',
//           ),
//           CustomHorizontalProductsList(
//             lists: lists[4],
//             categoryLable: 'Jewery',
//           ),
//           CustomHorizontalProductsList(
//             lists: lists[6],
//             categoryLable: 'Sports Products',
//           ),
//           CustomHorizontalProductsList(
//             lists: lists[7],
//             categoryLable: 'Stationary',
//           ),
//           CustomHorizontalProductsList(
//             lists: lists[8],
//             categoryLable: 'Kitchen Products',
//           ),
//           CustomHorizontalProductsList(
//             lists: lists[9],
//             categoryLable: 'Other Products',
//           ),
//         ],
//       ),
//     );
