  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: CustomAppBar(
          appBarTitle: '$categoryLabel Products',
        ),
                    ...
                    onDismissed: (direction) {
                      ...
                      if (direction == DismissDirection.endToStart) {
                        ...
                        if (!authController.isAuthenticated.isTrue) {
                          ...
                          SnackBar(content: Text('Login is required for this action')),
                        );
                        } else {
                          // If authenticated, add the item to the basket.
                          ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Added to basket succesfully.')),
                        );
                          
                          basketController.addItemToBasket(authController.uid.value, data["id"]); // Call to add item to the basket.
                        }
